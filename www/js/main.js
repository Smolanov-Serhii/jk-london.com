...
$('.form-1-3').load('form-1-3.html');
$('.form-1-4').load('form-1-4.html');
$('.form-1-5').load('form-1-5.html');
$('.form-catalog').load('form-catalog.html');
$('.form-catalog-2').load('form-catalog-2.html');
$('.form-recall').load('form-recall.html');
$('.form-timer').load('form-timer.html');
...
$(window).on('load',function(){
         window.setTimeout(infload, 3000); 
});